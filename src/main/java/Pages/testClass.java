...
public class testClass {
    ...
    public String getImgsc_containerForOnsie() {
            WebElement s=driver.findElement(img_container);
        return s.getScreenshotAs(OutputType.BASE64);
    }
    public File getImgFil_containerForOnsie() {
        WebElement s=driver.findElement(img_container);

        return s.getScreenshotAs(OutputType.FILE);
